package com.valorizeseusamigos.topfilms.presenter.components.button
...
fun PrimaryButton(
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            containerColor = TopFilmsTheme.colorScheme.defaultColor,
            disabledContainerColor = TopFilmsTheme.colorScheme.disabledDefaultColor,
        ),
